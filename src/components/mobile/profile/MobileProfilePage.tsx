...
export function MobileProfilePage() {
  ...
  const handleSaveProfile = async (profileData: any) => {
    try {
      ...
      // await api.profile.update.mutate(profileData);
    } catch (error) {
          ...
          <div className="text-center">
            ...
            <div className="relative inline-block mb-4">
              ...
              <button 
                ...
                className="absolute bottom-0 right-0 w-8 h-8 bg-[#2C5282] rounded-full flex items-center justify-center shadow-lg"
              >
