...
export const token = {
  ...
  radius: (key: keyof typeof designTokens.borderRadius) => designTokens.borderRadius[key],
  
  breakpoint: (key: keyof typeof designTokens.breakpoints) => designTokens.breakpoints[key],
};

// CSS custom properties for runtime theming (optional, for future theme provider)
export const cssVariables = `
  :root {
    ...
    /* Component tokens */
    --touch-target-min: ${designTokens.components.touchTarget.min};
    --button-height-base: ${designTokens.components.button.height.base};
  }
`;