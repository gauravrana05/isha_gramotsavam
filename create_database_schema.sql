...
-- CreateIndex
CREATE UNIQUE INDEX "user_verifications_user_id_verification_type_key" ON "public"."user_verifications"("user_id", "verification_type");
...
-- CreateIndex
CREATE UNIQUE INDEX "user_roles_user_id_event_id_role_key" ON "public"."user_roles"("user_id", "event_id", "role");
